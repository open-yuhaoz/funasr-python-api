...
class Funasr_websocket_recognizer():
    ...
    '''
    def __init__(self, host="127.0.0.1", port="10095", is_ssl=False,chunk_size="5, 10, 5",chunk_interval=10,mode="offline",wav_name="default"):
      '''
          host: server host ip
          port: server port
...
if __name__ == '__main__':
    ...
    import wave
    wav_path="/opt/wav/python/wav-data/mono_125244.022.1.wav"
    ...
    rcg=Funasr_websocket_recognizer(host="127.0.0.1",port="10095",is_ssl=False,mode="2pass")
    # loop to send chunk
